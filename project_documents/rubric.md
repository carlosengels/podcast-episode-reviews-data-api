...
|---                                                              |---                       |               |---                               |
|Team name                                                        |Sprint 1 Module 1         |               |name: Noobz                       |
|[Design Document - problem statement](design_document.md)        |Sprint 1 Module 2         |1/16/2023      |                                  |
|[Team Charter](team_charter.md)                                  |Sprint 1 Module 3         |N/A            |https://github.com/BloomTechBackend/bd-team-project-cengels/blob/main/project_documents/design_document.md                                  |
|[Design Document](design_document.md)                            |Sprint 1 REQUIRED TO GO ON|1/18/2023      |                                  |
...
https://podcast-review-api-documentation.s3.us-west-2.amazonaws.com/index.html#post-/reviews/-episodeId-/

*What we learned:*
We can use the API documentation YAML file to start creating the endpoints in the AWS API Gateway.
Lambda will be used to upload the source code and have it interact with the API endpoints and DynamoDB database.
...
* Will return an OK message
* .. or and error object if there is a client/server issue
